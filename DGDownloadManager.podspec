...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shaoyeliudiange@163.com/DGDownloadManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shaoyeliudiange@163.com' => 'hzycode@163.com' }
  s.source           = { :git => 'https://github.com/shaoyeliudiange@163.com/DGDownloadManager.git', :tag => s.version.to_s }
